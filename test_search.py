...
testable_params = [
    # {"birthDate": "gt1974-12-23"},
    # {"birthDate": "eq1974-12-25"},
    # {'address.postalCode': 'gt10001'},
    # {'address.postalCode': 'eq10001'}
    # {'id:contains': 'example'},
    # {'id:exact': 'example'},
    # {'id:in': 'example'}
    # {'id:not-in': 'example'},
    # {'address.city:contains': 'Pleasant'},
    # {'address.city:exact': 'Pleasantville'},
    # {'address.city:not-in': 'Pleasantville'},
    # {'address.city:in': 'Pleasantville'}
    
    # {'id:not': 'example'},
    # {'address.city:not': 'Pleasantville'},
    # {'id:below': 'ex'},
    # {'address.city:below': 'Pleasant'},
    # {"identifier.system:below": "urn:oid:0"},
    # {}
    # {"id:exact": "example"},
]
