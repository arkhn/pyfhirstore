...
class Formatter:
    ...
    def parse_format_arguments(self, url_args, resource):
        parsed_args = URL_Parser(url_args, resource)
    ...
    def initiate_bundle(self, url_args, resource):
        self.parse_format_arguments(url_args, resource)
    ...
    def complete_bundle(self, new_bundle, resource):
